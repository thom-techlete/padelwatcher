...
def test_time_range_functionality():
    ...
    for court_info in results:
        ...
        print(f"     Time: {court_info['start_time']} - {court_info['end_time']} | Price: {court_info['price']}")
    ...
    print(f"   Search order details:")
    print(f"     Date: {order_results['date']}")
    print(f"     Time range: {order_results['start_time_range']} - {order_results['end_time_range']}")
