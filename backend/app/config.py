...
# ============================================================================
if IS_PRODUCTION:
    CORS_ORIGINS = os.environ.get('CORS_ORIGINS', 'https://padelwatcher.techletes.ai,https://www.padelwatcher.techletes.ai').split(',')
else:
...
if IS_PRODUCTION:
    if not GMAIL_AUTH_CODE or not GMAIL_SENDER_EMAIL:
        raise ValueError("Email configuration (GMAIL_AUTH_CODE, GMAIL_SENDER_EMAIL) must be set in production")

# ============================================================================
# FRONTEND CONFIGURATION
# ============================================================================
if IS_PRODUCTION:
    FRONTEND_BASE_URL = os.environ.get('FRONTEND_BASE_URL', 'https://padelwatcher.techletes.ai')
else:
