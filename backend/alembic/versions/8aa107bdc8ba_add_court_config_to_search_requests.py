...
def upgrade() -> None:
    ...
    op.alter_column('availabilities', 'end_time',
               ...
               type_=sa.Time(),
               existing_nullable=False)
    op.alter_column('availabilities', 'price',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=False)
    op.alter_column('availabilities', 'available',
    ...
    op.alter_column('courts', 'name',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=False)
    op.alter_column('courts', 'sport',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=True)
    op.alter_column('courts', 'indoor',
               existing_type=sa.BOOLEAN(),
               nullable=True,
               existing_server_default=sa.text('(false)'))
    op.alter_column('courts', 'double',
               existing_type=sa.BOOLEAN(),
               nullable=True,
               existing_server_default=sa.text('(false)'))
    ...
    op.alter_column('locations', 'name',
               ...
               type_=sa.String(),
               existing_nullable=False)
    op.alter_column('locations', 'tenant_id',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=True)
    ...
    op.alter_column('locations', 'address',
               ...
               type_=sa.String(),
               existing_nullable=True)
    op.alter_column('locations', 'opening_hours',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=True)
    op.alter_column('locations', 'sport_ids',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=True)
    op.alter_column('locations', 'communications_language',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=True)
    ...
    op.alter_column('search_order_notifications', 'notified',
               existing_type=sa.BOOLEAN(),
               nullable=True,
               existing_server_default=sa.text('(false)'))
    ...
    op.drop_constraint(None, 'search_order_notifications', type_='foreignkey')
    op.drop_constraint(None, 'search_order_notifications', type_='foreignkey')
    op.create_foreign_key(None, 'search_order_notifications', 'search_orders', ['search_order_id'], ['id'])
    op.create_foreign_key(None, 'search_order_notifications', 'availabilities', ['availability_id'], ['id'])
    op.create_foreign_key(None, 'search_order_notifications', 'courts', ['court_id'], ['id'])
    op.alter_column('search_orders', 'date',
               existing_type=sa.DATETIME(),
               type_=sa.Date(),
               existing_nullable=False)
    op.alter_column('search_orders', 'start_time_range',
               existing_type=sa.TEXT(),
               type_=sa.Time(),
               existing_nullable=False)
    op.alter_column('search_orders', 'end_time_range',
               existing_type=sa.TEXT(),
               type_=sa.Time(),
               existing_nullable=False)
    op.alter_column('search_orders', 'created_at',
               existing_type=sa.DATETIME(),
               nullable=True,
               existing_server_default=sa.text('(CURRENT_TIMESTAMP)'))
    op.alter_column('search_orders', 'status',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               nullable=True,
               existing_server_default=sa.text("'active'"))
    op.alter_column('search_orders', 'user_id',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=True)
    op.alter_column('search_requests', 'search_hash',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=False)
    op.alter_column('search_requests', 'date',
               existing_type=sa.DATETIME(),
               type_=sa.Date(),
               existing_nullable=False)
    op.alter_column('search_requests', 'start_time',
               existing_type=sa.TEXT(),
               type_=sa.Time(),
               existing_nullable=False)
    op.alter_column('search_requests', 'end_time',
               existing_type=sa.TEXT(),
               type_=sa.Time(),
               existing_nullable=False)
    op.alter_column('search_requests', 'court_type',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               nullable=True,
               existing_server_default=sa.text("'all'"))
    op.alter_column('search_requests', 'court_config',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=True,
               existing_server_default=sa.text("'all'"))
    op.alter_column('search_requests', 'location_ids',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=False)
    op.alter_column('search_requests', 'live_search',
               existing_type=sa.BOOLEAN(),
               nullable=True,
               existing_server_default=sa.text('(false)'))
    op.alter_column('search_requests', 'performed_at',
               existing_type=sa.DATETIME(),
               nullable=True,
               existing_server_default=sa.text('(CURRENT_TIMESTAMP)'))
    op.alter_column('search_requests', 'slots_found',
    ...
    op.alter_column('users', 'created_at',
               ...
               nullable=True,
               existing_server_default=sa.text('(CURRENT_TIMESTAMP)'))
    op.alter_column('users', 'approved_by',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=True)
...
def downgrade() -> None:
    ...
    op.create_index(op.f('search_requests_search_hash_key'), 'search_requests', ['search_hash'], unique=1)
    op.alter_column('search_requests', 'slots_found',
               existing_type=sa.INTEGER(),
               nullable=False,
               existing_server_default=sa.text('0'))
    ...
    op.drop_constraint(None, 'search_order_notifications', type_='foreignkey')
    op.drop_constraint(None, 'search_order_notifications', type_='foreignkey')
    op.create_foreign_key(None, 'search_order_notifications', 'search_orders', ['search_order_id'], ['id'], onupdate='CASCADE', ondelete='RESTRICT')
    op.create_foreign_key(None, 'search_order_notifications', 'availabilities', ['availability_id'], ['id'], onupdate='CASCADE', ondelete='RESTRICT')
    op.create_foreign_key(None, 'search_order_notifications', 'courts', ['court_id'], ['id'], onupdate='CASCADE', ondelete='RESTRICT')
    op.alter_column('search_order_notifications', 'notified',
               existing_type=sa.BOOLEAN(),
               nullable=False,
               existing_server_default=sa.text('(false)'))
    ...
    op.alter_column('providers', 'name',
               ...
               existing_nullable=False)
    op.drop_constraint(None, 'locations', type_='foreignkey')
    op.create_foreign_key(None, 'locations', 'providers', ['provider_id'], ['id'], onupdate='CASCADE', ondelete='RESTRICT')
    ...
    op.alter_column('locations', 'name',
               ...
               existing_nullable=False)
    op.drop_constraint(None, 'courts', type_='foreignkey')
    op.create_foreign_key(None, 'courts', 'locations', ['location_id'], ['id'], onupdate='CASCADE', ondelete='RESTRICT')
    op.alter_column('courts', 'double',
               existing_type=sa.BOOLEAN(),
               nullable=False,
               existing_server_default=sa.text('(false)'))
    ...
    op.alter_column('courts', 'name',
               ...
               existing_nullable=False)
    op.drop_constraint(None, 'availabilities', type_='foreignkey')
    op.create_foreign_key(None, 'availabilities', 'courts', ['court_id'], ['id'], onupdate='CASCADE', ondelete='RESTRICT')
    op.alter_column('availabilities', 'available',
               existing_type=sa.BOOLEAN(),
               nullable=False,
               existing_server_default=sa.text('(true)'))
